...
public class DailyPost  extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()){
                    case  R.id.gohome:
                        Intent homeIntent = new Intent(DailyPost.this, MainActivity.class);
                    ...
                    case R.id.about:
                        Intent aboutus = new Intent(DailyPost.this , AboutUs.class);
        ...
        if(!isInternetavalable()){
            android.app.AlertDialog.Builder checkBuilder = new android.app.AlertDialog.Builder(DailyPost.this);
    ...
    public void onBackPressed() {
        if (webView.canGoBack()){
            ...
            AlertDialog.Builder checkBuider = new AlertDialog.Builder(DailyPost.this);
            ...
            checkBuider.setPositiveButton("NO", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    Intent sameIntent = new Intent(DailyPost.this, BBCnews.class);
                }
            });
