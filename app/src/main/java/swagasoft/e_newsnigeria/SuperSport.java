...
public class SuperSport  extends AppCompatActivity{
    private ActionBarDrawerToggle mToogle;
    private WebView webView;
    private SwipeRefreshLayout myswipe;
    private  Intent chooser;
    // --Commented out by Inspection (9/19/2018 11:43 PM):private Button AboutClick;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()){
                    case  R.id.gohome:
                        Intent homeIntent = new Intent(SuperSport.this, MainActivity.class);
                    ...
                    case R.id.about:
                        Intent aboutus = new Intent(SuperSport.this , AboutUs.class);
        ...
        if(!isInternetavalable()){
            android.app.AlertDialog.Builder checkBuilder = new android.app.AlertDialog.Builder(SuperSport.this);
    ...
    private void loadWebviewInSwipe()
    {
        ...
        webView.loadUrl("https://www.supersport.com/football");
    ...
    public void onBackPressed() {
        if (webView.canGoBack()){
            ...
            AlertDialog.Builder checkBuider = new AlertDialog.Builder(SuperSport.this);
            ...
            checkBuider.setPositiveButton("NO", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    Intent sameIntent = new Intent(SuperSport.this, BBCnews.class);
                }
            });
