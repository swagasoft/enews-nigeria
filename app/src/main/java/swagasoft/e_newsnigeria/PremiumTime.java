...
public class PremiumTime  extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()){
                    case  R.id.gohome:
                        Intent homeIntent = new Intent(PremiumTime.this, MainActivity.class);
                    ...
                    case R.id.about:
                        Intent aboutus = new Intent(PremiumTime.this , AboutUs.class);
        ...
        if(!isInternetavalable()){
            android.app.AlertDialog.Builder checkBuilder = new android.app.AlertDialog.Builder(PremiumTime.this);
    ...
    private void loadWebviewInSwipe()
    {
        ...
        webView.loadUrl("https://www.premiumtimesng.com/");
    ...
    public void onBackPressed() {
        if (webView.canGoBack()){
            ...
            AlertDialog.Builder checkBuider = new AlertDialog.Builder(PremiumTime.this);
            ...
            checkBuider.setPositiveButton("NO", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    Intent sameIntent = new Intent(PremiumTime.this, BBCnews.class);
                }
            });
